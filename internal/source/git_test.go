...
func TestGitCredentialsSSHAuthReportsNoUsableIdentity(t *testing.T) {
	useSSHEnvironment(t, syntheticSSHEnvironment(t, t.TempDir()))
...
func TestGitCredentialsSSHAuthUsesAmbientIdentityWithoutKeyFile(t *testing.T) {
...
func TestGitCredentialsSSHAuthExplicitKeyVerifiesHostKeys(t *testing.T) {
	home := writeSSHHome(t, "example.com")
	useSSHEnvironment(t, syntheticSSHEnvironment(t, home))
...
func writeKnownHostsEntry(t *testing.T, path, host string) cryptossh.PublicKey {
	t.Helper()
